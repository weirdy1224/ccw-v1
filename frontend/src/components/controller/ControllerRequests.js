...
const ControllerRequests = () => {
  ...
  const renderStatus = (status) => {
    ...
    switch (status) {
      case "Assigned":
        bg = "#fff3cd"; color = "#856404"; break;
      case "Closed":
      case "Completed":
        bg = "#d4edda"; color = "#155724"; break;
      case "Rejected":
        bg = "#f8d7da"; color = "#721c24"; break;
      case "Pending":
        bg = "#cce5ff"; color = "#004085"; break;
      default:
  ...
  const renderDocuments = (req) => {
    ...
    return (
      <div className="docs-preview-container" style={{ display: "flex", flexWrap: "wrap", gap: "14px 24px" }}>
        {docs.map(({ url, type }, i) => (
                    ...
                    >
                      ...
                      <td>
                        <select
                          ...
                          onClick={(e) => e.stopPropagation()} // prevent row expand when clicking dropdown
